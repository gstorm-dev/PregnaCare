...
const Navbar = () => {
  ...
  const mobileLinkClass = (active) =>
    `px-3 py-3 transition ${
      active
        ? "bg-[#fff0ea] text-[#b66d58]"
        : "hover:bg-[#fff0ea] hover:text-[#b66d58]"
    }`;
          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-1 text-sm font-semibold text-[#3b4944]">
            ...
            <div className="mt-2 flex gap-3 border-t border-[#eadfd9] pt-3">
              <Link
                to="/patient/login"
                onClick={closeMenu}
                className="flex-1 rounded-lg px-4 py-2.5 text-center text-[#3b4944] transition hover:bg-[#fff0ea] hover:text-[#b66d58]"
              >
                Login
              </Link>
              <Link
                to="/patient/signup"
                onClick={closeMenu}
                className="flex-1 rounded-lg bg-[#d98268] px-4 py-2.5 text-center text-white transition hover:bg-[#c66f57]"
              >
                Sign Up
              </Link>
            </div>
