...
const PatientAppointments = () => {
  ...
  return (
    <PatientPage eyebrow="Care calendar" title="Your appointments">
      <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_.9fr]">
        <section className="rounded-2xl border border-[#eadfd9] bg-white p-6 shadow-[0_10px_30px_rgba(125,79,62,.05)]">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            ...
            <Detail
              icon={MapPin}
              label="Location"
              value="Lagos Women's Centre"
            />
          </div>
          <div className="mt-6 border-t border-[#f0e8e3] pt-5">
            <p className="text-sm text-[#69736f]">With</p>
            <p className="mt-1 font-semibold">Dr. Sarah Johnson</p>
        ...
        <section className="rounded-2xl border border-[#eadfd9] bg-white p-6 shadow-[0_10px_30px_rgba(125,79,62,.05)]">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#dbeafe] text-[#2563eb]">
          ...
          {booked ? (
            <div className="mt-8 rounded-xl bg-[#edf3ef] p-5 text-center">
              ...
              <p className="mt-1 text-sm text-[#69736f]">
                {doctor} will confirm your visit shortly.
              </p>
              <button
                type="button"
      ...
      <Link
        to="/patient/doctors"
        className="mt-6 inline-flex text-sm font-semibold text-[#2563eb]"
      >
        Find another doctor
      </Link>
    </PatientPage>
...
const Detail = ({ icon: Icon, label, value }) => (
  <div className="rounded-xl bg-[#f8fbff] p-4">
    ...
    <p className="mt-3 text-xs text-[#8a928e]">{label}</p>
